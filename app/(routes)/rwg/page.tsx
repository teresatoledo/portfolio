...
function Page() {
  return (
    ...
    <div className='flex flex-col justify-center gap-3 ml-4 sm:mx-16'>
      ...
      <p>It has a <span className='font-bold'>built-in timer</span> that you can pause and restart as many times as you like so you don&apos;t need any additional tools to work out, with RWG you have it all in one place.</p>
      <p>One of the most important functionalities that RWG includes is a <span className='font-bold'>built-in video</span> for each exercise. You can click on each one of the exercises and watch a tutorial on how to do that movement.</p>
      <p>If you&apos;ve logged in, you&apos;ll have the ability to <span className='font-bold'>save the workout as a favourite,</span> which you can then view at any time in your profile.</p>
      <p>The profile offers a wealth of opportunities for users: from basic functions such as viewing your data or <span className='font-bold'>changing your password</span>, to other RWG features such as viewing your saved workouts as favourites, a <span className='font-bold'>record of maximum lifts</span> for each available exercise and a <span className='font-bold'>calorie calculator</span> that you can customize with your data and goals, so you can get the most out of your workouts.</p>
      <p>You also have available a <span className='font-bold'>FAQ section</span> in case you have any doubts about how to use any of the functionalities RWG offers.</p>
